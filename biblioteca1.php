  ...
  <body>
    ...
    <body>
      <div class="search-container">
        ...
        <path d="M22 14C21.4477 14 21 13.5523 21 13C21 12.4477 21.4477 12 22 12C22.5523 12 23 12.4477 23 13C23 13.5523 22.5523 14 22 14Z" fill="#B5FF00" /><!-- SVG para el icono de búsqueda -->
          </svg>
        </div>
      </div>
    ...
    <div class="container">
      <div class="card">
        <img class="background" src="https://c4.wallpaperflare.com/wallpaper/535/658/344/belico-guerras-juego-video-wallpaper-preview.jpg" alt="">
        ...
        <div class="card-content">
          ...
          <h3 class="title">Obras Dramaticas</h3>
        </div>
        <div class="backdrop"></div>
      </div>

      <div class="card">
        <img class="background" src="https://images.ctfassets.net/qpn1gztbusu2/3NlZRUavqGF4DShsbuOQHc/57dbb2ddc2e6090435717f3affed4cad/Caballo_de_Troya.webp" alt="">
        ...
        <div class="card-content">
          ...
          <h3 class="title">Misterios</h3>
        </div>
        <div class="backdrop"></div>
      </div>

      <div class="card">
        <img class="background" src="https://media.revistagq.com/photos/6037433b0b0aad9e3fa59cf0/16:9/w_2560%2Cc_limit/salem.jpg" alt="">
        ...
        <div class="card-content">
          ...
          <h3 class="title">Terror</h3>
        </div>
        <div class="backdrop"></div>
      </div>

      <div class="card">
        <img class="background" src="https://image.cdn2.seaart.ai/2023-11-01/21499296403691525/3497d04f187c30563db449d5f560231991a16693_high.webp" alt="">
      ...
      <div class="card">
        ...
        <div class="card-content">
          ...
          <h3 class="title">Ciencia Ficcion</h3>
        </div>
        <div class="backdrop"></div>
      </div>
    </div>
